...
INSERT INTO `gift_certificates` (`name`, `description`, `price`, `duration`, `create_date`)
VALUES('Car', 'Fast car', '99.99', 4, '2011-11-19T11:10:11.111');

INSERT INTO `gift_certificates` (`name`, `description`, `price`, `duration`, `create_date`)
VALUES('Sand', 'Yellow sand', '2.35', 24, '2020-05-05T23:42:12.112');

INSERT INTO `gift_certificates` (`name`, `description`, `price`, `duration`, `create_date`)
VALUES('City', 'Large city', '1000', 2, '2021-05-10T08:42:10.145');

INSERT INTO `gift_certificates` (`name`, `description`, `price`, `duration`, `create_date`)
VALUES('Plane', 'Fly plain', '452.12', 6, '2016-01-29T16:30:21.211');

INSERT INTO `gift_certificates` (`name`, `description`, `price`, `duration`, `create_date`)
VALUES('Ferry', 'Ferryman', '0.99', 14, '2019-11-19T11:10:11.111');
